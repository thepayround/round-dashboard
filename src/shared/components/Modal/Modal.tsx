                  ...
                  <div className="relative flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <div className="h-1 w-12 bg-gradient-to-r from-[#D417C8] to-[#7767DA] rounded-full" />
                      </div>
                    ...
                    {showCloseButton && (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.9 }}
                        onClick={onClose}
                        className="p-2 rounded-xl bg-white/10 border border-white/20 text-gray-400 hover:text-white hover:bg-white/20 hover:border-white/30 transition-all duration-200"
                      >
                        <X className="w-5 h-5" />
                      </motion.button>
                    )}
