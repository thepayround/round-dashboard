...
// UI primitives - Re-export Shadcn components
...
export { Drawer } from '../widgets/Drawer'
export type { DrawerProps } from '../widgets/Drawer'
// Deprecated: Use Drawer instead
export { Drawer as FilterPanel } from '../widgets/Drawer'
export type { DrawerProps as FilterPanelProps } from '../widgets/Drawer'
