          ...
          <div className="px-6 py-4">
            ...
            <div className="flex items-center space-x-4 flex-1">
              ...
              <div className="relative">
                <div className="p-3 rounded-xl bg-gradient-to-br from-[#D417C8]/20 to-[#14BDEA]/20 border border-white/10">
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="relative" ref={dropdownRef} style={{ zIndex: showActions ? 99999 : 'auto' }}>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="w-9 h-9 rounded-xl bg-gradient-to-br from-white/10 to-white/5 border border-white/20 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-200 hover:from-white/15 hover:to-white/10 hover:border-white/30 shadow-lg"
              onClick={(e) => {
                e.preventDefault()
