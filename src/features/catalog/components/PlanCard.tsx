          ...
          <div className="px-6 py-4">
            ...
            <div className="flex items-center space-x-4 flex-1">
              ...
              <div className="relative">
                <div className="p-3 rounded-xl bg-gradient-to-br from-[#7767DA]/20 to-[#D417C8]/20 border border-white/10">
                ...
                {showActions && (
                  ...
                  >
                    <div className="bg-black/90 backdrop-blur-xl border border-white/20 rounded-2xl overflow-hidden">
                      <div className="bg-gradient-to-r from-[#7767DA]/20 to-[#D417C8]/20 px-4 py-3 border-b border-white/10">
