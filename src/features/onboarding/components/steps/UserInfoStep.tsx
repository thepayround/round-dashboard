    ...
    >
      ...
      <div className="text-center space-y-4">
        <motion.div
          ...
          className="w-16 h-16 mx-auto rounded-lg bg-gradient-to-br from-[#D417C8]/20 to-[#14BDEA]/20 backdrop-blur-sm border border-white/20 flex items-center justify-center"
        >
